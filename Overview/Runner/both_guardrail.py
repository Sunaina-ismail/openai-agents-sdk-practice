...
async def run_input_guardrail(
    ...
    print("RunInputGuardrail has been triggered")
...
async def run_output_guardrail(
    ...
    print("RunOutputGuardrail has been triggered")
    return GuardrailFunctionOutput(
        output_info="Successfull",
        tripwire_triggered=False
    )
...
config=RunConfig(
    input_guardrails=[run_input_guardrail],
    output_guardrails=[run_output_guardrail],
)
...
async def filter_out_irrelevant_quries(
    ...
    print("AgentInputGuardrail has been triggered")
    return GuardrailFunctionOutput(
...
async def extract_karachi_fields(
    ...
    print("AgentOutputGuardrail has been triggered")
