from agents import Agent, Runner, AsyncOpenAI, OpenAIChatCompletionsModel, set_tracing_disabled, AgentHooks, function_tool, enable_verbose_stdout_logging, ModelSettings
...
class CustomAgentHooks(AgentHooks):
    async def on_start(self, context, mera_agent):
        print(f"{mera_agent.name} is started")
    ...
    async def on_handoff(self, agent, source, context):
